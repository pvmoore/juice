...
final public class Text {
    ...
    public Text appendText(String text, int x, int y) {
        var ch = new Chunk();
        ch.text = text;
        ch.x = x;
        ch.y = y;
    ...
    public Text replaceText(int index, String text) {
